        ...
        <div className="py-8">
          ...
          {activeTab === "delivery" && (
            <div className="space-y-4 text-text-secondary">
              <p>Доставка осуществляется через логистических партнёров СДЭК/Boxberry по 9 странам: Россия, Казахстан, Беларусь, Армения, Азербайджан, Грузия, Сербия, Хорватия, Болгария.</p>
              <p>Точная стоимость и сроки рассчитываются на этапе оформления заказа после выбора страны и города.</p>
