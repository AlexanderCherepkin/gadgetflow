      ...
      <main className="flex-1 py-8 md:py-12">
        <div className="container-tight max-w-3xl">
          ...
          <div className="space-y-6 text-text-secondary">
            <p>
              Настоящая Политика конфиденциальности описывает, как ИП Иванов Иван Иванович (далее — «GadgetFlow») собирает, использует и защищает персональные данные пользователей интернет-магазина.
            </p>
            ...
            <p>
              Вы имеете право запросить информацию о ваших данных, потребовать их исправления или удаления, а также отозвать согласие на обработку. Для этого свяжитесь с нами по email hello@gadgetflow.by.
            </p>
          </div>
        </div>
      </main>
